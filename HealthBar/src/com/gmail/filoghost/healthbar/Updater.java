...
//////////////////////////////////////////////
	...
	public static class UpdaterHandler {
		...
		public static void startupUpdateCheck() {
			...
			if (plugin == null) {
				try { throw new Exception("The developer did not setup the updater correctly");
				} catch (Exception continueRuntime) { continueRuntime.printStackTrace(); /*does not interrupt runtime*/ }
				return;
			}
